; Hacked by mysticello555@gmail.com
      processor 6502
...
ChangeColor:
	 LSR                        ;If bit 0 of the color is set                                              ;2    
       ...
       LDA $0080,Y             ;Get flash color (usually the low counter.)                                ;4
...
StartGame:                                                                                                        
	 SEI                        ;Set Interupts Off                                                         ;2    
       ...
       sta      $EE                 ; I can probably comment this line out.
...
MainGameLoop_2:
       lda    $EE	;Music Hack. The register that will determine if the music call gets skipped, to allow for the rest of the program to run normally.
       BNE    SkipMusic	;Music Hack. Run the rest of the program as normal if not equal; skips over the following "jsr Music" line.
       
       jsr      Music	;Music Hack. Play the music.

SkipMusic:		;Music Hack

       dec     $EE	;Music Hack. Both of these "dec" lines act as a clock to determine when to loop the music over and over (until the game stops).
       dec     $EE	;Music Hack
...
;The below Music subroutine is part of the Music Hack.
Music: ;Music is located here to be in the byte range of a branch.                                                     ;3
    
    lda     #$00 ;Set the noise type into register $E0. Maybe not needed?*
    STA     $E0	

    lda     #$FF ;Set the noise count.
    sta     $DF
		 ;Setting the noise type and count is how the other sounds are created in this program.
    rts
...
MoveGroundObject_2:
       ...
       LDA $00C8,Y             ;Get the portal state.                                                     ;4
...
;Deal with object moving out of a castle.                                                                          
       ...
       LDA    #$01                                                                                           ;2    
       STA $00C8,Y             ;Set the portcullis state to 01.                                           ;5
       RTS                                                                                                   ;6    
...
GetLinkedObject_2:                                                                                                                   
       ...
       CMP $0000,Y             ;Combare with object2's room.                                              ;4
...
GetLinkedObject_6:                                                                                                                   
       LDA $0002,Y             ;Get Object2's Y Coordinate.                                               ;4    
